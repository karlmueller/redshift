...
#include <stdlib.h>
#include <stdint.h>
//#if ARDUINO >= 100 //===COMMENTED FOR USE WITHIN ACCELSTRUT MODIFICATION OF ACCELSTEPPER FOR ESP32
//#include <Arduino.h>
//#else
//#include <WProgram.h>
//#include <wiring.h>
...
public:
    ...
    /// Take in a long value to set the new target position value outside of the runToPosition command
    void setTargetPos(long newTarget);
